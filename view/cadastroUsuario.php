...
<main class="form-signin bg-dark rounded-3 text-white bg-gradient bg-opacity-75 rounded-3 FormAnimation">
  <form method="POST" action="../modals/crud.php">
    ...
    <div class="container">
      ...
      <label for="Name" class="form-label my-1">Primeiro Nome</label>
      <input type="text" name="nome" class="form-control" required>

      <label for="Name" class="form-label my-1">Sobrenome</label>
      <input type="text" name="nome" class="form-control" required>
    ...
    <button name="exe" value="cadastrarUsuario" class="my-3 w-100 btn mb-4 btn-lg btn-outline-success" type="submit">Entrar</button>
